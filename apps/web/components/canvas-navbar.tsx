    ...
    <div className='flex space-x-2 items-center justify-center m-1'>
      ...
      >
        <svg
          ...
          viewBox='-2 -2 24 24'
          fill='#a7a7ac'
          className={`${selectedTool === "Rectangle" ? "bg-[#403e6a] text-white" : ""} hover:bg-[#31303b]  hover:scale-105 transition-all duration-300 ease-in-out rounded-md p-2`}
        >
      ...
      >
        <svg
          xmlns='http://www.w3.org/2000/svg'
          viewBox='0 0 32 32'
          className={`${selectedTool === "Ellipse" ? "bg-[#403e6a] text-white" : ""} hover:bg-[#31303b]  hover:scale-105 transition-all duration-300 ease-in-out rounded-md p-2`}
        >
          <circle
            cx={16}
            cy={16}
      ...
      >
        <svg
          ...
          data-name='Layer 1'
          viewBox='0 0 24 24'
          className={`${selectedTool === "Diamond" ? "bg-[#403e6a] text-white" : ""} hover:bg-[#31303b] hover:scale-105 transition-all duration-300 ease-in-out rounded-md p-2`}
        >
      ...
      >
        <svg
          ...
          fill='#a7a7ac'
          viewBox='0 0 24 24'
          className={`${selectedTool === "Arrow" ? "bg-[#403e6a] text-white" : ""}  hover:bg-[#31303b] hover:scale-105 transition-all duration-300 ease-in-out rounded-md p-2`}
        >
      ...
      >
        <svg
          ...
          viewBox='0 0 100 100'
          fill='#a7a7ac'
          className={`${selectedTool === "Line" ? "bg-[#403e6a] text-white" : ""} hover:bg-[#31303b] hover:scale-105 transition-all duration-300 ease-in-out rounded-md p-2`}
        >
      ...
      >
        <svg
          ...
          fill='#a7a7ac'
          viewBox='0 0 36 36'
          className={`${selectedTool === "Text" ? "bg-[#403e6a] text-white" : ""} hover:bg-[#31303b] hover:scale-105 transition-all duration-300 ease-in-out rounded-md p-2`}
        >
      ...
      >
        <svg
          ...
          xmlSpace='preserve'
          className={`${selectedTool === "Pencil" ? "bg-[#403e6a] text-white" : ""} hover:bg-[#31303b] hover:scale-105 transition-all duration-300 ease-in-out rounded-md p-2`}
        >
          <path
            fill='none'
            stroke='#a7a7ac'
